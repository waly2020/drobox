...
const AddFiles = () => {
    ...
    return (
        ...
        <input className="absolute top-0 left-0 w-full h-full select-none border-none outline-none opacity-0 cursor-pointer" onChange={onSelectFile} multiple accept="image/png,image/jpg,image/jpeg" type="file"/>
        </div>
