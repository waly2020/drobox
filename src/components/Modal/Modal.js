...
const Modal = ({title = "Add new title...",children,onClose,active = false}) => {
    ...
    return (
        <motion.div variants={modalVariants} style={modalVariants.close} animate={active ? "open" : "close"} className="fixed left-0 top-0s z-50 w-screen h-screen bg-[rgba(0,0,0,0.2)] flex justify-center items-center p-3">
